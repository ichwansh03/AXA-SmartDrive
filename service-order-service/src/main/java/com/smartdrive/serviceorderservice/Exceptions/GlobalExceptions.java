...
public class GlobalExceptions {
    ...
    public ResponseEntity<java.lang.Error> handleTokenRefreshException(TokenRefreshException ex, WebRequest request) {
   ...
   public ResponseEntity<?> handleValidasi(ValidasiRequestException e){
    ...
    public ResponseEntity<?> jwtExpired(JwtExpiredException ex){
        java.lang.Error error = ErrorUtils.createError("Token expired, you can refresh with refreshtoken in /auth/refreshtoken",
